...
module.exports = {
  async createRide(req, res) {
    ...
    try {
      ...
      console.log(
        `Pickup Coordinates: ${pickupCoordinates.ltd}, ${pickupCoordinates.lng}`
      );
      ...
      captainsInRadius.forEach((captain) => {
        console.log(
          `Captain ${captain._id} has coordinates: ${captain.location.latitude}, ${captain.location.longitude}`
        );
        if (!captain.socketId) {
        ...
        console.log(
          `Notifying Captain: ${captain._id}, Socket ID: ${captain.socketId}`
        );
        try {
          ...
          console.error(
            `Error sending message to Captain ${captain._id}:`,
            error
          );
        }
      });
